                    ...
                    <div class="scrollbar-sidebar">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                <li class="app-sidebar__heading" id="type">Alumno</li>
                                <li>
                                    <a href="home.html" >
                                ...
                                <li>
                                    <a href="examenes.html" class="mm-active">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Examenes
                                        <div class="page-title-subheading">Aqui podras ver las calificaciones de las materias cursadas y en curso
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">PROXIMOS EXAMENES
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">Desinscripcion</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"> 
                                                    <button onclick="eliminarExamen()" class="mr-2 btn-icon btn-icon-only btn btn-outline-danger">Desinscribirse</button> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">62</td>
                                                <td class="text-left">INGENIERIA DE SOFTWARE</td>
                                                <td class="text-center">14-03-2024</td>
                                                <td class="text-center">18:00</td>
                                                <td class="text-center"> 
                                                    <button onclick="eliminarExamen()" class="mr-2 btn-icon btn-icon-only btn btn-outline-danger">Desinscribirse</button> 
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">MODELADO 3D</td>
                                                <td class="text-center">14-03-2024</td>
                                                <td class="text-center">18:00</td>
                                                <td class="text-center"> 
                                                    <button onclick="eliminarExamen()" class="mr-2 btn-icon btn-icon-only btn btn-outline-danger">Desinscribirse</button> 
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">INSCRIBIRSE A EXAMENES
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">18:00</td>
                                                <td class="text-center"> 
                                                    <button onclick="inscribirExamen()" class="mr-2 btn-icon btn-icon-only btn btn-outline-success">Inscribir</button> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">62</td>
